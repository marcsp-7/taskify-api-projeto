...
public class TarefaController {
    ...
    @GetMapping("/{id}")
    public Optional<Tarefa> listarTarefaPeloId(@PathVariable("id") Long id) {
    ...
    public List<Tarefa> obterTarefasDeProjeto(@PathVariable("id") Long id) {
        return tarefaRepository.findByProjeto(id);
    }

    @GetMapping("/usuario/{id}")
    public List<Tarefa> obterTarefasDeUsuario(@PathVariable("id") Long id) {
